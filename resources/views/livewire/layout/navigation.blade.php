        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link class="text-decoration-none" :href="route('profile')" wire:navigate>
                            {{ __('Profile') }}
                        </x-dropdown-link>

                        <x-dropdown-link class="text-decoration-none" :href="route('posts.index')" wire:navigate>
                            {{ __('Posts') }}
                        </x-dropdown-link>
